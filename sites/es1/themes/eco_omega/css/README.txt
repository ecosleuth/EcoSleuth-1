...
To use these stylesheets, rename the files and eco_omega with the name of your theme.
...
eco_omega-alpha-default-narrow.css
...
eco_omega-alpha-default-normal.css
...
eco_omega-alpha-default-wide.css
